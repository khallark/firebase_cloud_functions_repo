...
//     try {
//       const { businessId, name, sku, unit, category, reorderLevel, supplierName } = req.body as {
//         businessId: string;
//         name: string;
//         sku: string;
//         unit: string;
...
//     try {
//       const { businessId, bomId, quantityPerPiece, wastagePercent, consumedAtStage } = req.body as {
//         businessId: string;
//         bomId: string;
//         quantityPerPiece?: number;
//         wastagePercent?: number;
